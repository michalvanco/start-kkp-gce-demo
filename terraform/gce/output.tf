    ...
    "${var.cluster_name}-pool-a" = {
      ...
      providerSpec = {
        ...
        cloudProviderSpec = {
          ...
          multizone = true
          labels = {
            "${var.cluster_name}-workers" = "pool-a"
          }
          tags     = ["firewall", "targets", "${var.cluster_name}-pool-a"]
          regional = false
    ...
    "${var.cluster_name}-pool-b" = {
      ...
      providerSpec = {
        ...
        cloudProviderSpec = {
          ...
          multizone = true
          labels = {
            "${var.cluster_name}-workers" = "pool-b"
          }
          tags     = ["firewall", "targets", "${var.cluster_name}-pool-b"]
          regional = false
          # Use custom image (optional)
          # customImage = ""
        }
    ...
    "${var.cluster_name}-pool-c" = {
      ...
      providerSpec = {
        ...
        cloudProviderSpec = {
          ...
          multizone = true
          labels = {
            "${var.cluster_name}-workers" = "pool-c"
          }
          tags     = ["firewall", "targets", "${var.cluster_name}-pool-c"]
          regional = false
          # Use custom image (optional)
          # customImage = ""
        }
